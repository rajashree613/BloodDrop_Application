...
<html lang="en">
  ...
  <body>
    ...
    if(isset($_POST['submit'])){
      ...
      $insertquery = " insert into login(name,password) values('$name',no','$password')";
    ...
    <input type='password'name="name" class='input-field'placeholder='Enter Password' required>
